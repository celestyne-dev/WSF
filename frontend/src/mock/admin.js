...
export const storySubmissions = [
  ...
  },
  {
    ...
    countryCode: 'US',
    title: 'How I Negotiated a 30% Raise by Asking the Wrong Question',
    excerpt: 'My manager expected me to ask for more money. Instead I asked why the role was scoped the way it was — and the raise followed.',
  ...
  },
  {
    id: 'sub7',
    name: 'Alice Whitmore',
    email: 'alice.whitmore@example.com',
    countryCode: 'GB',
    title: 'Returning to Work After a Two-Year Career Break',
    excerpt: 'Every recruiter told me the gap on my CV was a liability. It became the best interview story I had.',
